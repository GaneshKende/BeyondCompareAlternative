...
--MID: 101421; CID: 50300; Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo 
...
BEGIN
    RAISERROR(
                 N'Warning: Updating settings for a game variant (ModuleId 101421, ClientId 50300) whose ModuleId is in tb_ExcludeModule',
                 10,
                 1
             );
    PRINT('');
...
BEGIN CATCH
    ...
    END;
    RAISERROR(N'ERROR:Error in Region Module for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR:Error in  Region Game Categories for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN TRY
    ...
    SET ClientName = 'Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo',
        ClientTypeID = 70,
    ...
    BEGIN
        ...
        VALUES
        (101421, 50300, 'Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo', 3, @TranslationStringID, 70);
    END;
END TRY
BEGIN CATCH
    SET @Msg = ERROR_MESSAGE();
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in  Region Default Language Game Name for ModuleID 101421, ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN TRY
    ...
    VALUES
          ...
          (101421, 50300, 'HasBonusFeature', 1, NULL),
          (101421, 50300, 'HasGambleFeature', 0, NULL),
          (101421, 50300, 'HasFreeSpinFeature', 1, NULL),
          (101421, 50300, 'HasNudgeFeature', 0, NULL),
          (101421, 50300, 'IsWayGame', 0, NULL),
          (101421, 50300, 'PaylineCountWithCost', 10, NULL)
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR:  Error in  Region Common Game Setting  for ModuleID 101421, ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------
--Install tb_BetModel ,tb_BetModelSetting , tb_BetModelGame for  101421,50300,Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo
--------------------------------------------------------------------------------------------
BEGIN TRY
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in Region Bet Model for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
BEGIN TRY
...
--------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------
--Install tb_SettingTemplate for 101421,50300,Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo
--------------------------------------------------------------------------------------------
BEGIN TRY
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in  Region Setting Template  for ModuleID 101421, ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------
--Install tb_SettingTemplateValue for 101421, 50300, Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo
--------------------------------------------------------------------------------------------
...
BEGIN TRY
    ...
    BEGIN
        ...
        VALUES
        --TemplateID:-0
        (0,101421,50300,105,64,2500, NULL)
        --TemplateID:-0
        ,(0,101421,50300,106,64,20, NULL)
        --TemplateID:-0
        ,(0,101421,50300,214,64,200, NULL)
        --TemplateID:-0
        ,(0,101421,50300,952,64,1, NULL)
        --TemplateID:-0
        ,(0,101421,50300,955,64,10, NULL)
        --TemplateID:-0
        ,(0,101421,50300,956,64,10, NULL)
        --TemplateID:-0
        ,(0,101421,50300,948,64,10, NULL)
        --TemplateID:-0
        ,(0,101421,50300,949,64,10, NULL)
        --TemplateID:-0
        ,(0,101421,50300,950,64,10, NULL)
        --TemplateID:-0
        ,(0,101421,50300,953,64,-1, NULL)
        --TemplateID:-1
        ,(1,101421,50300,105,64,2500, NULL)
        --TemplateID:-1
        ,(1,101421,50300,106,64,20, NULL)
        --TemplateID:-1
        ,(1,101421,50300,214,64,200, NULL)
        --TemplateID:-1
        ,(1,101421,50300,952,64,1, NULL)
        --TemplateID:-1
        ,(1,101421,50300,955,64,10, NULL)
        --TemplateID:-1
        ,(1,101421,50300,956,64,10, NULL)
        --TemplateID:-1
        ,(1,101421,50300,948,64,10, NULL)
        --TemplateID:-1
        ,(1,101421,50300,949,64,10, NULL)
        --TemplateID:-1
        ,(1,101421,50300,950,64,10, NULL)
        --TemplateID:-1
        ,(1,101421,50300,953,64,-1, NULL)
        --TemplateID:-2
        ,(2,101421,50300,105,64,2500, NULL)
        --TemplateID:-2
        ,(2,101421,50300,106,64,20, NULL)
        --TemplateID:-2
        ,(2,101421,50300,214,64,200, NULL)
        --TemplateID:-2
        ,(2,101421,50300,952,64,1, NULL)
        --TemplateID:-2
        ,(2,101421,50300,955,64,10, NULL)
        --TemplateID:-2
        ,(2,101421,50300,956,64,10, NULL)
        --TemplateID:-2
        ,(2,101421,50300,948,64,10, NULL)
        --TemplateID:-2
        ,(2,101421,50300,949,64,10, NULL)
        --TemplateID:-2
        ,(2,101421,50300,950,64,10, NULL)
        --TemplateID:-2
        ,(2,101421,50300,953,64,-1, NULL)
        --TemplateID:-4
        ,(4,101421,50300,105,64,10000, NULL)
        --TemplateID:-4
        ,(4,101421,50300,106,64,100, NULL)
        --TemplateID:-4
        ,(4,101421,50300,214,64,1000, NULL)
        --TemplateID:-4
        ,(4,101421,50300,953,64,-1, NULL)
        --TemplateID:-5
        ,(5,101421,50300,105,64,20000, NULL)
        --TemplateID:-5
        ,(5,101421,50300,106,64,200, NULL)
        --TemplateID:-5
        ,(5,101421,50300,214,64,2000, NULL)
        --TemplateID:-5
        ,(5,101421,50300,953,64,-1, NULL)
        --TemplateID:-6
        ,(6,101421,50300,105,64,100000, NULL)
        --TemplateID:-6
        ,(6,101421,50300,106,64,1000, NULL)
        --TemplateID:-6
        ,(6,101421,50300,214,64,10000, NULL)
        --TemplateID:-6
        ,(6,101421,50300,953,64,-1, NULL)
        --TemplateID:-7
        ,(7,101421,50300,106,64,2000, NULL)
        --TemplateID:-7
        ,(7,101421,50300,214,64,20000, NULL)
        --TemplateID:-7
        ,(7,101421,50300,953,64,-1, NULL)
        --TemplateID:-10
        ,(10,101421,50300,106,64,10000, NULL)
        --TemplateID:-10
        ,(10,101421,50300,214,64,100000, NULL)
        --TemplateID:-10
        ,(10,101421,50300,953,64,-1, NULL)
        --TemplateID:-13
        ,(13,101421,50300,105,64,50000, NULL)
        --TemplateID:-13
        ,(13,101421,50300,106,64,250, NULL)
        --TemplateID:-13
        ,(13,101421,50300,214,64,2500, NULL)
        --TemplateID:-13
        ,(13,101421,50300,953,64,-1, NULL)
        --TemplateID:-14
        ,(14,101421,50300,106,64,2000, NULL)
        --TemplateID:-14
        ,(14,101421,50300,214,64,20000, NULL)
        --TemplateID:-14
        ,(14,101421,50300,953,64,-1, NULL)
    END;
    ...
    BEGIN
        ...
        VALUES
        --TemplateID:-7
        (7,101421,50300,105,64,200000, NULL)
        --TemplateID:-10
        ,(10,101421,50300,105,64,200000, NULL)
        --TemplateID:-14
        ,(14,101421,50300,105,64,200000, NULL)
    END;
    ...
    BEGIN
        ...
        VALUES
        --TemplateID:-7
        (7,101421,50300,105,64,250000, NULL)
        --TemplateID:-8
        ,(8,101421,50300,105,64,2000000, NULL)
        --TemplateID:-8
        ,(8,101421,50300,106,64,20000, NULL)
        --TemplateID:-8
        ,(8,101421,50300,214,64,200000, NULL)
        --TemplateID:-8
        ,(8,101421,50300,953,64,-1, NULL)
        --TemplateID:-10
        ,(10,101421,50300,105,64,1000000, NULL)
        --TemplateID:-14
        ,(14,101421,50300,105,64,500000, NULL)
        --TemplateID:-15
        ,(15,101421,50300,105,64,10000000, NULL)
        --TemplateID:-15
        ,(15,101421,50300,106,64,100000, NULL)
        --TemplateID:-15
        ,(15,101421,50300,214,64,1000000, NULL)
        --TemplateID:-15
        ,(15,101421,50300,953,64,-1, NULL)
        --TemplateID:-16
        ,(16,101421,50300,105,64,20000000, NULL)
        --TemplateID:-16
        ,(16,101421,50300,106,64,200000, NULL)
        --TemplateID:-16
        ,(16,101421,50300,214,64,2000000, NULL)
        --TemplateID:-16
        ,(16,101421,50300,953,64,-1, NULL)
        --TemplateID:-17
        ,(17,101421,50300,105,64,5000000, NULL)
        --TemplateID:-17
        ,(17,101421,50300,106,64,25000, NULL)
        --TemplateID:-17
        ,(17,101421,50300,214,64,250000, NULL)
        --TemplateID:-17
        ,(17,101421,50300,953,64,-1, NULL)
    END;
END TRY
BEGIN CATCH
    SET @Msg = ERROR_MESSAGE();
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in  Region Setting Template Value  for ModuleID 101421, ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------
--Install tb_MGSDefaultModuleSetting for  101421   , 50300, Slingshot - HTML5 Desktop - Slot - Candy Combo™ - Power Combo 
--------------------------------------------------------------------------------------------
BEGIN TRY
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in  Region MSGDefaultSettings for ModuleID 101421 ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN TRY
    ...
    EXEC pr_ApplyTemplateValuesToPGSI 0, 101421, 50300, @ForceUpdate;
    --Apply the settings that do not belong to a Bet Model
    EXEC pr_ApplyMGSDefaultModuleSettings 101421, 50300, @ForceUpdate;
END TRY
BEGIN CATCH
    SET @Msg = ERROR_MESSAGE();
    IF (XACT_STATE()) <> 0
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR:Error occured in Region PGSI and MGS Default Setting for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in Region Thermometer Setting for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in Region Exclude Module for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in Region Free Game Support Client for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR: Error in  Region Slot Valid Bet Limits for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN CATCH
    ...
    BEGIN
        ...
        ROLLBACK TRANSACTION;
    END;
    RAISERROR(N'ERROR:Error in Region Extended Bet Setting for ModuleID 101421 and ClientID 50300', 15, 1);
    RAISERROR(@Msg, 15, 1);
    RETURN;
END CATCH;
--------------------------------------------------------------------------------------------
...
BEGIN
    ...
    EXEC @installationResult = pr_ValidateGameInstall 101421, 50300;
